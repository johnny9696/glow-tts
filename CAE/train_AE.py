...
global_step=1
config_path='/home/caijb/Desktop/Zero shot GLow TTS/CAE/configs/base.json'
...
def train_and_eval(rank,n_gpu, hps):
    ...
    AE_model = model(encoder_dim=hps.model.encoder_dim, hidden_1dim=hps.model.hidden_dim1, kernel=hps.model.kernel).to(device)
