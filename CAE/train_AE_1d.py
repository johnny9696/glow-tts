...
from mel_data_1d import Mel_loader, MelCollate
from CAE_1d import Convolution_Auto_Encoder as model
        ...
        if rank == 0 :
            if batch_id % hps.train.log_interval == 0:
                ...
                utils.summarize(
                    ...
                    images = {"mel_original" : utils.plot_spectrogram_to_numpy(mel_padded[0].data.cpu().numpy()),
                    "mel_predict" : utils.plot_spectrogram_to_numpy(mel_hat[0].data.cpu().numpy())},
